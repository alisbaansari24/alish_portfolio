  ...
  return (
    <section id="about" className="py-28 relative">
      ...
      <div className="relative max-w-5xl mx-auto text-center px-6">
        <h3 className="text-4xl font-bold bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent">
          About Me
        </h3>

        <p className="mt-8 text-gray-300 leading-relaxed text-lg">
          I am a <span className="text-white font-medium">Front-End Developer</span>{" "}
        ...
        <p className="mt-6 text-gray-400 leading-relaxed text-base max-w-3xl mx-auto">
