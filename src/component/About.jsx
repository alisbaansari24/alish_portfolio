  ...
  return (
    <section id="about" className="py-20 sm:py-24 md:py-28 relative">
      ...
      <div className="relative max-w-5xl mx-auto text-center px-5 sm:px-6">
        ...
        <p className="mt-6 sm:mt-8 text-gray-300 leading-relaxed text-base sm:text-md md:text-center text-justify">
          I am a{" "}
        ...
        <p className="md:text-center text-justify mt-5 sm:mt-6 text-gray-400 leading-relaxed text-sm sm:text-sm max-w-3xl mx-auto">
